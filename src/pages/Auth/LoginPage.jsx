  ...
  return (
    ...
    <div className='w-screen flex justify-between items-center md:flex-row flex-col h-[100vh]'>
      ...
      <div className='hidden  bg-[#F8F5FF] h-[100vh] sm:flex justify-center items-center'>
        <img src={LoginBg} alt="Taxi Dashboard - Login" className='h-[30rem] bg-contain' loading='lazy' />
      </div>
      ...
      <div className='my-5 mx-10 flex-1 flex justify-center items-start flex-col '>
        ...
        <p className='mt-2 text-sm ml-3 sm:ml-0'> <span className='text-[#FF6600] mr-1'>Welome back! </span>sign in with your email and password</p>
        {/* FORM  */}
        <form action="sm:mx-10" onSubmit={handleSubmit}>
          ...
          <p className='w-[20.5rem] sm:w-[22rem] text-right mt-2 text-sm cursor-pointer mr-6 sm:mr-0'>Forget Password?</p>
          ...
          {/* <p className='w-[20.5rem] sm:w-[22rem] ml-3 sm:ml-0 text-center mt-2 text-sm cursor-pointer md:pb-0 pb-3'>Don't have an account? <Link to={"/register"} className='text-[#ED5529] font-semibold'>Signup</Link></p> */}
